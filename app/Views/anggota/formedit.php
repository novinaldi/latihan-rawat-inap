    ...
    <div class="card-body">
        ...
        <form method="post" action="/anggota/update">
            ...
            <div class="form-group">
                ...
                <input readonly type="text" name="kodeanggota" maxlength="5" class="form-control form-control-sm"
                    value="<?= $kode; ?>">
                <?php
                if (isset($validation)) {
                    echo '<br>';
            ...
            <div class="form-group">
                ...
                <input type="text" name="namaanggota" class="form-control form-control-sm" value="<?= $nama; ?>">
                <?php
                if (isset($validation)) {
                    echo '<br>';
                    echo '<span style="color:red; font-size:11px">';
            ...
            <div class="form-group">
                ...
                <br>
                <input type="radio" name="jenkel" value="L" <?php if ($jk == 'L') echo 'checked'; ?>> Laki-Laki &nbsp;
                <input type="radio" name="jenkel" value="P" <?php if ($jk == 'P') echo 'checked'; ?>> Perempuan
                <?php
                if (isset($validation)) {
                    echo '<br>';
                    echo '<span style="color:red; font-size:11px">';
            ...
            <div class="form-group">
                ...
                <input type="text" name="telp" class="form-control form-control-sm" value="<?= $nama; ?>">
                <?php
                if (isset($validation)) {
                    echo '<br>';
                    echo '<span style="color:red; font-size:11px">';
